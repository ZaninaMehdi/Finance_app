...
class CompanyConfig:
    ...
    def _initialize_config(self, company_name):
        ...
        self.bedrock_agent_bedrock_allow_policy_name = f"bda-bedrock-allow-{company_name}"
        self.bedrock_agent_s3_allow_policy_name = f"bda-s3-allow-{company_name}"
        self.bedrock_agent_kb_allow_policy_name = f"bda-kb-allow-{company_name}"
        self.agent_role_name = f'AmazonBedrockExecutionRoleForAgents_{company_name}'
        ...
        self.kb_role_name = f'AmazonBedrockExecutionRoleForKnowledgeBase_{company_name}'
        self.kb_bedrock_allow_policy_name = f"bd-kb-bedrock-allow-{company_name}"
        self.kb_aoss_allow_policy_name = f"bd-kb-aoss-allow-{company_name}"
        self.kb_s3_allow_policy_name = f"bd-kb-s3-allow-{company_name}"
